...
t.add("error.field.empty", "Ce champ est obligatoire", "validators", "fr");
t.add("error.field.integer", "Ce champ doit contenir une valeur num\u00e9rique", "validators", "fr");
t.add("error.field.message_url", "Ce champ ne contient pas une URL de tweet ou de post facebook valide.", "validators", "fr");
t.add("error.broadcast.unique", "Ce nom de diffusion est d\u00e9j\u00e0 utilis\u00e9", "validators", "fr");
t.add("error.source.empty", "Aucune source n'a \u00e9t\u00e9 renseign\u00e9e", "validators", "fr");
t.add("error.source.url.invalid", "Ce champ ne contient pas une URL", "validators", "fr");
t.add("error.source.url.unique", "L'URL de cette source existe d\u00e9j\u00e0", "validators", "fr");
t.add("error.source.url.json", "Ce champ ne contient pas une URL au format JSON", "validators", "fr");
t.add("error.source.url.invalid_fb", "Ce champ ne contient pas une URL de post Facebook valide", "validators", "fr");
t.add("error.source.hashtag.invalid", "Ce champ ne contient pas de #", "validators", "fr");
t.add("error.source.name.unique", "Ce nom de source est d\u00e9j\u00e0 utilis\u00e9", "validators", "fr");
t.add("error.sms.text.invalid", "Le texte ne doit pas commencer par 30 caracteres alphanumeriques", "validators", "fr");
})(Translator);
